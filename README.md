...
Kristnandet förändrade även sättet att ordna och återfinna tid i skrift. Den latinska kyrkan förde med sig computus, helgonkalendrar och tabeller som gjorde det möjligt att föra en lokal uppgift till ett gemensamt dagtal. Övergången var inte nödvändigtvis omedelbar. En skrivare kunde möta en femledad datering som angav året, namnet på en återkommande avdelning, dagen inom denna, namnet på en annan serie och dagens plats i den serien, utan att därmed ensam ange en entydig dag i den latinska tideräkningen.

För att läsa en sådan uppgift baklänges måste man också känna den dag från vilken den ursprungliga beräkningen hade utförts. Om denna beräkningsdag själv hade skrivits i samma femledade form fick den först lösas på motsvarande sätt; hänvisningar i flera led blev därmed en rekursiv kronologisk fråga. Angavs beräkningsdagen som identisk med den sökta dagen återstod i stället en genomgång av ett i förväg avgränsat tidsintervall. En föreslagen lösning kunde godtas först sedan den räknats framåt på nytt och återgett samtliga fem led utan avvikelse. Flera möjliga dagar kunde i princip bestå efter prövningen, vilket förklarar varför kyrklig standardisering av dateringen var en praktisk fråga och inte bara en symbol för religiös anslutning.
...
## En randanmärkning om tideräkningen

I en sen avskrift finns en randanmärkning som beskriver hur en dag skall få sitt fullständiga namn. Den använder en sluten talring vars största tal erhålls genom att börja med ett, fördubbla etthundratjugosju gånger och därefter dra bort ett. Att bevara ett tal betyder att föra det runt denna ring tills det ligger mellan ett och det största talet; en jämn multipel av ringens storlek skrivs som det största talet och aldrig som noll. Alla ordnade mängder räknas från ett och jämförs lexikografiskt. När flera värden byts samtidigt skall varje nytt värde räknas endast ur de gamla.

Som fästdag används den tjugoandra december år fyrtioett tusen tvåhundratjugotvå före vår tideräkning, vilken har ordningstalet minus femton miljoner femtiofem tusen sexhundrasjuttioett när den första januari år ett räknas som ett. Fästdagen får talet ett. En dag som ligger ett visst antal dygn efter den får det dubbla av avståndet ökat med ett, medan en dag som ligger lika långt före den får det dubbla av avståndet utan tillägg. Av beräkningsdagen och den efterfrågade dagen bildas fem tal: deras respektive dagtal, deras absoluta avstånd ökat med ett, summan av dagtalen samt ett riktningstal som är ett bakåt, två vid samma dag och tre framåt.

Var och en av de fyrtiosex synliga dropparna har fem stenar, kallade vete, korn, salt, bitter och röd. Den första droppens stenar är sjutton, tjugonio, fyrtiotre, sjuttioett och etthundraett. Varje senare uppsättning räknas samtidigt ur den föregående: den nya vetestenen är den gamla vetestenens kvadrat, plus tre gamla kornstenar och droppens ordningsnummer; den nya kornstenen är den gamla kornstenens kvadrat, plus fem gamla saltstenar och en gammal vetesten; den nya saltstenen är den gamla saltstenens kvadrat, plus sju gamla bitterstenar och en gammal kornsten; den nya bitterstenen är den gamla bitterstenens kvadrat, plus elva gamla röda stenar och en gammal saltsten; och den nya röda stenen är den gamla röda stenens kvadrat, plus tretton gamla vetestenar och en gammal bittersten. Varje resultat bevaras i talringen.

Före den första synliga droppen står sju dolda droppar, ordnade så att den första ligger närmast. För den dolda droppen med ordningsnummer från ett till sju läggs beräkningsdagens tal till följande: frågedagens tal multiplicerat med två gånger ordningsnumret plus ett, avståndstalet multiplicerat med tre gånger ordningsnumret plus ett, summatalet multiplicerat med fyra gånger ordningsnumret plus två, riktningstalet multiplicerat med fyra gånger ordningsnumret plus fyra samt alla fem stenarna från den synliga droppe som har samma nummer. Summan bevaras. Därefter mals varje dold droppe sju gånger. Vid varje malning kvadreras dess gamla värde, tre gånger samma gamla värde läggs till, därefter en sten och slutligen malningens ordningsnummer. Stenarna tas i följden vete, korn, salt, bitter, röd, vete och korn.

De dolda dropparna placeras före de synliga som den sjunde dolda, den sjätte och så vidare fram till den första dolda, följd av den första synliga. För varje synlig droppe bildas först en deg av dess vetesten gånger beräkningsdagens tal, dess kornsten gånger frågedagens tal, dess saltsten gånger avståndstalet, dess bittersten gånger summatalet och dess röda sten gånger riktningstalet. Därtill kommer den närmast föregående droppen, tre gånger den tredje föregående, fem gånger den sjunde föregående och den nya droppens ordningsnummer. Degen bevaras och mals elva gånger. Vid en malning kvadreras det gamla degvärdet, varefter samma gamla värde och de första, tredje och sjunde föregående dropparna multipliceras med fyra på varandra följande tal ur primtalsföljden tre, fem, sju, elva, tretton, sjutton, nitton, tjugotre, tjugonio, trettioett, trettiosju, fyrtioett, fyrtiotre och fyrtiosju. Den första malningen använder följdens första till fjärde tal, den andra dess andra till femte, och så vidare. Slutligen läggs en sten till; stenföljden är vete, korn, salt, bitter, röd och därefter samma följd från början. Resultatet av den elfte malningen är droppen, och en droppe skall avslutas innan nästa påbörjas.

Sex skålar numreras i fast ordning. Till skålens begynnelsevärde läggs beräkningsdagens tal, frågedagens tal multiplicerat med skålens nummer, avståndstalet, summatalet, riktningstalet samt kvadraten av ett särskilt tal. Dessa särskilda tal är i skålarnas ordning sjutton, nitton, tjugotre, tjugonio, trettioett och trettiosju. Summan kvadreras, skålens nummer läggs till och resultatet bevaras.

Varje synlig droppe väljer en av de sjuhundratjugo lexikografiskt ordnade permutationerna av de sex skålarna; dess plats är droppens värde minskat med ett, taget med vanlig rest vid division med sjuhundratjugo och därefter ökat med ett. Droppen hälls direkt i de tre första skålarna i denna ordning. Den första hällningen är droppens kvadrat plus vetestenen gånger den första skålens gamla innehåll och tre gånger droppens nummer. Den andra använder kornstenen, den andra skålen och fem gånger numret; den tredje använder saltstenen, den tredje skålen och sju gånger numret. Alla tre bevaras.

Skålarna betraktas sedan som en cirkel i den valda ordningen. För varje position tas skålens gamla innehåll, två gånger den föregående grannens gamla innehåll, tre gånger den följande grannens gamla innehåll, den direkta hällningen om någon, hela droppen och en positionssten. Positionsstenarna är vete, korn, salt, bitter, röd och vete. Summan kvadreras; därefter läggs fem gånger produkten av de båda gamla grannarnas innehåll samt droppens nummer gånger positionens nummer till. Resultatet bevaras. Först när alla sex nya innehåll har räknats ut ersätts de gamla samtidigt. Detta upprepas för samtliga fyrtiosex droppar.

Efter den sista droppen följer tolv omrörningar. Vid varje omrörning summeras de sex gamla skålarna, etthundrafyrtionio gånger omrörningens nummer läggs till och summan bevaras. Detta tal väljer på samma sätt en av de sjuhundratjugo skålordningarna. För varje position summeras skålens gamla innehåll, tre gånger den föregående grannens gamla innehåll, fem gånger den följande grannens gamla innehåll, den bevarade skålsumman, omrörningens nummer och kvadraten av positionens nummer. Summan kvadreras, sju gånger produkten av de två gamla grannarna läggs till, och resultatet bevaras. Även här byts alla sex värden samtidigt. När skålarna senare frågas används emellertid ordningen från den fyrtiosjätte droppen, inte ordningen från den sista omrörningen.

En fråga ställs till en bestämd skål med ett bestämt sigill. Nästa skål är dess efterföljare i cirkeln från den fyrtiosjätte droppen. Det första svarstalet fås genom att till den frågade skålen lägga sigillet och etthundraåttioett, kvadrera summan, lägga till etthundrasjuttionio gånger nästa skåls innehåll och sigillet samt bevara resultatet. Riktningen bestäms genom att till detta svarstal lägga sigillet, ett och etthundranittiotre, kvadrera summan, lägga till etthundranittiotre gånger svarstalet och etthundranittiosju gånger innehållet i den skål som har det fasta namnet sex samt bevara. Ett udda riktningstal betyder att följande svarstal går ett steg framåt i talringen; ett jämnt betyder ett steg bakåt. Följden passerar därför varje ringtal exakt en gång innan den återkommer.

När ett av ett givet antal ordnade alternativ skall väljas utan snedfördelning används denna svarsföljd. Om antalet alternativ inte överstiger talringens storlek tas den största hela multipeln av antalet alternativ som ryms i ringen. Svarstal ovanför denna gräns förkastas tills ett godtagbart nås; från detta dras ett, vanlig rest tas vid division med antalet alternativ och ett läggs tillbaka. Om alternativen är fler än ringtalen väljs det minsta antal baspositioner vars totala rymd inte är mindre än antalet alternativ. Lika många på varandra följande svarstal, vart och ett minskat med ett, används som siffror i basen som är lika med ringens storlek, den första som minst betydande; ett läggs till. Detta breda tal vandrar sedan ett steg i den redan bestämda riktningen genom hela den breda rymden. Tal ovanför den största hela multipeln av antalet alternativ förkastas, och det första godtagbara talet omvandlas med samma restregel till ett alternativ. En ny och oberoende svarsgrupp får inte tas efter ett förkastande.

Fästdagen är en central kotlettport. För den port som ligger ett steg på en viss sida körs hela förfarandet med fästdagen som beräkningsdag och den första dagen på denna sida som frågedag; för den andra porten används den andra dagen, och så vidare. Skål ett frågas med sigill ett, ett tal väljs likformigt bland de niohundratjugotvå första positiva heltalen och fyrtioett läggs till. De på så sätt erhållna avstånden, alltid mellan fyrtiotvå och niohundrasextiotre dagar, summeras utåt på vardera sidan.

För en given beräkningsdag betraktas alla par av portar där den vänstra ligger före dagen, den högra inte före den, minst sex portmellanrum ingår och längden ligger mellan tvåhundrafemtiotvå och femtusen sjuhundraåttioett dagar. Paren ordnas först efter stigande längd och sedan efter tidigare vänsterport. Hela skålförfarandet körs med beräkningsdagen även som frågedag; skål ett frågas med sigill tio, och det valda paret kallas år femtusen. Nästa år börjar efter detta års slutport, använder samma port som frågedag, ordnar alla giltiga senare slutportar på samma sätt och väljs med sigill elva. Det föregående året fås spegelvänt från öppningsporten med sigill tolv. Man går alltid år för år, och numreringen passerar från ett till noll och därefter till minus ett.

När ett års gränser är kända körs skålförfarandet en gång med beräkningsdagen och årets första dag. Antalet kotletter väljs med skål två och sigill tjugo bland de möjliga talen från sex till sjutton, dock aldrig fler än årets portmellanrum. Därefter väljs med samma skål och sigill tjugoett en lexikografiskt ordnad positiv sammansättning av portmellanrummen i så många delar; om beräkningsdagen själv är en inre port måste en del sluta där. Med skål fem och sigill tjugotvå väljs en ordnad följd utan upprepning ur namnen Brons, Räv, Njure, Lagaš, Tanke, Fyra niondelar, Palguarš, Säv, Druvklase, Skorpion, Aska, Vete, Flod, Skratt, Akkad, Horn och Den tomma krukan.

Om årets längd är given väljs månadsantalet med skål tre och sigill trettio. Det minsta tillåtna antalet är årslängden delad med etthundratjugotre och avrundad uppåt; det största är årslängden delad med fyra och avrundad nedåt, men aldrig större än fyrtiosju. Med samma skål och sigill trettioett väljs därefter lexikografiskt en sammansättning av årets dagar där varje månad har minst fyra och högst etthundratjugotre dagar. Med skål fyra och sigill trettiotvå väljs en hel väv av månadsindex: varje index förekommer exakt så många gånger som månaden har dagar, de första förekomsterna av månadsindexen står i stigande ordning och deras sista förekomster likaså. Med skål fem och sigill trettiotre väljs slutligen, utan upprepning och i ordning, månadsnamnen Lera, Granatäpple, Armbåge, Avund, Eridu, Tandkräm, Tre femtedelar, Karšumav, Tiger, Tenn, Dimma, Olibanum, Slända, Revben, Johannesbröd, Uruk, Skam, Kamel, Koppar, Brunn, Äggula, Stjärna, Honung, Mjälte, Kalksten, Glädje, Fikon, Nineve, Groda, Beck, Ljus, Den stängda dörren, Sesam, Nacke, Silver, Lilja, Storm, Åsna, Mjöl, Ånger, Babylon, Tunga, Lin, Salt, Päron, Båge och Sand.

Den efterfrågade dagen får slutligen exakt fem uppgifter: årets nummer, namnet på den kotlett som innehåller dagen, dagens ordningsnummer inom kotletten räknat från ett, namnet på månadsindexet som står på dagens plats i väven och antalet gånger samma månadsindex har förekommit från årets början till och med dagen. Inga ytterligare led hör till själva dagsnamnet.
