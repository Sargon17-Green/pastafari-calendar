...
const requirementSpecs=[
  ...
  ["SAUCE-STONES","7 hidden drops, 46 visible drops, stone rows and eleven grinds","§ רוטב/אבנים","verification/reference-oracle/reference.mjs","browser/pastafari-calendar-core.js","fresh-bowlsum-vs-ordernumber"],
  ...
  ["FINAL-STIRS","12 final stirs; preserved orderNumber enters u and also determines the order","§ 12 בחישות","verification/reference-oracle/reference.mjs","browser/pastafari-calendar-core.js","fresh-bowlsum-vs-ordernumber"],
