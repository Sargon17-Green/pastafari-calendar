...
| is | is-IS | ltr | partial | draft |
| it | it-IT | ltr | partial | draft |
| ja | ja-JP | ltr | partial | draft |
| jv | jv-ID | ltr | partial | draft |
| ka | ka-GE | ltr | partial | draft |
| kk | kk-KZ | ltr | partial | draft |
| ko | ko-KR | ltr | partial | draft |
| lb | lb-LU | ltr | partial | draft |
| lt | lt-LT | ltr | partial | draft |
| lv | lv-LV | ltr | partial | draft |
| mk | mk-MK | ltr | partial | draft |
| mr | mr-IN | ltr | partial | draft |
| ms | ms-MY | ltr | partial | draft |
| nb | nb-NO | ltr | partial | draft |
| ne | ne-NP | ltr | partial | draft |
| nl | nl-NL | ltr | partial | draft |
| nn | nn-NO | ltr | partial | draft |
| pa | pa-IN | ltr | partial | draft |
| pl | pl-PL | ltr | partial | draft |
| pt | pt-BR | ltr | partial | draft |
| ro | ro-RO | ltr | partial | draft |
| ru | ru-RU | ltr | partial | draft |
| sk | sk-SK | ltr | partial | draft |
| sl | sl-SI | ltr | partial | draft |
| so | so-SO | ltr | partial | draft |
| sq | sq-AL | ltr | partial | draft |
| sr | sr-Latn-RS | ltr | partial | draft |
...
| tr | tr-TR | ltr | partial | draft |
| uk | uk-UA | ltr | partial | draft |
| ur | ur-PK | rtl | partial | draft |
| uz | uz-UZ | ltr | partial | draft |
...
- All 71 target locales have complete article drafts. Native-language whole-site text QA is now complete through `gl-ES`: `af-ZA`, `az-AZ`, `be-BY`, `bg-BG`, `et-EE`, `fo-FO`, `fy-NL`, and `gl-ES` are at `linguistic QA`; the remaining 63 target locales remain at `draft` pending the same native-language pass.
