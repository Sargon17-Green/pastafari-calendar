...
export default Object.freeze({
  ...
  "messages": {
    ...
    "about.toc": "Inhoud",
    "about.fallbackNotice": "Die verduideliking is nog nie in die gekose taal beskikbaar nie; daarom word die verstekweergawe gewys.",
    ...
    "search.intro": "Kies 'n kalender, voer 'n datum in en kies ‘Wys datum’. Die huidige Pastafari-dag word by verstek ingevul.",
    ...
    "settings.intro": "Die aksiedag is die uitgangspunt van die berekening. By verstek gebruik die webwerf die huidige Pastafari-dag wat vir die aktiewe waarnemerligging bepaal is.",
    ...
    "year.cutletCountLabel": "Kotelette",
    "year.monthCountLabel": "Maande",
    ...
    "guide.1.heading": "Maak die webwerf oop en sien vandag se datum",
    "guide.1.body": "Sodra die skakel oopmaak, bepaal die webwerf die huidige Pastafari-dag vir die aktiewe waarnemerligging en wys die kotelet waarin dié dag val. Die daggrens is die liggingafhanklike onderste meridiaanoorgang van Venus wat in ASTRONOMICAL-DAY.md beskryf word; dit is nie burgerlike middernag nie. Daar is geen registrasie of aanmelding nie, en geen datum word na 'n berekeningsbediener gestuur nie.",
    ...
    "guide.4.body": "‘Vorige kotelet’ en ‘Volgende kotelet’ gaan na aangrensende kotelette. Ander dagteëls is nie knoppies nie, omdat 'n klik daarop niks doen nie. ‘Terug na vandag’ stel sowel die soektog as die aksiedag terug na die huidige Pastafari-dag.",
    "guide.5.heading": "Verander die aksiedag",
    "guide.5.body": "Maak ‘Opsies vir berekening en vergelyking’ onder die soekfunksie oop. Daar kan jy 'n kalender kies en 'n ander aksiedag invoer. Verdere soektogte gebruik daardie aksiedag totdat jy na die huidige Pastafari-dag terugstel. Hierdie gevorderde instelling bly beskikbaar sonder om die gewone aansig oorvol te maak.",
