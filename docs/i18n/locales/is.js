...
export default Object.freeze({
  ...
  "messages": {
    ...
    "manifest.defaultDescription": "Staðbundið, determinískt Pastafari-dagatal.",
    "app.title": "Pastafari-dagatal",
    "nav.skip": "Fara í dagsetningarleit",
    "app.intro": "Finndu dag í hvaða studdu dagatali sem er og skoðaðu síðan fulla Pastafari-dagsetningu hans og kótelettuna sem hann tilheyrir.",
    "guide.open": "Hvernig nota ég þennan vef?",
    "guide.openShort": "Hvernig á að nota vefinn",
    "reverse.error.absoluteDateField": "Ógildur reitur er í algildu dagsetningunni.",
    ...
    "about.metaDescription": "Skýring á Pastafari-dagatalinu: aðgerðardagur og fyrirspurnardagur, ár, kótelettur, samtvinnaðir mánuðir, dagamörk og háþróuð kerfi.",
    ...
    "search.intro": "Veldu dagatal, sláðu inn dagsetningu og veldu „Sýna dagsetningu“.",
    ...
    "comparison.toggleHelp": "Tiltækt á tölvu. Hver lína sýnir sama fyrirspurnardag undir tveimur aðgerðardögum.",
    ...
    "comparison.intro": "Hver lína inniheldur nákvæmlega sama fyrirspurnardag. Aðeins aðgerðardagurinn er ólíkur milli fyrri og seinni dálks.",
    "comparison.sameDay": "Dagur sem báðir útreikningar eiga sameiginlegan",
    ...
    "calendarInput.hinduOldSolar": "Fornt hindú — sólar",
    "calendarInput.hinduOldLunar": "Fornt hindú — tungl",
    ...
    "loading.title": "Leita að kótelettu og dagsetningu…",
    ...
    "year.context": "Þessi uppbygging er reiknuð fyrir aðgerðardaginn {actionDate}. Ef aðgerðardeginum er breytt geta ársmörk, kótelettur og mánuðir verið byggð upp að nýju.",
    "year.loading": "Byggi upp alla ársuppbygginguna…",
    ...
    "target.notInView": "Leitaða dagsetningin er enn vistuð; kótelettan sem nú er sýnd er önnur.",
    ...
    "guide.1.body": "Engin skráning eða innskráning er nauðsynleg og engin dagsetning er send á netþjón. Stóra fyrirsögnin og merkingin í reitnum gera daginn í dag ótvíræðan.",
    ...
    "guide.4.body": "„Fyrri kóteletta“ og „Næsta kóteletta“ fara í nágrannakótelettur. Hinir dagareitirnir eru ekki hnappar því smellur á þá gerir ekkert.",
    "guide.5.heading": "Breyttu aðgerðardeginum",
    "guide.5.body": "Opnaðu „Valkostir fyrir útreikning og samanburð“ undir leitinni. Þar geturðu valið dagatal og slegið inn annan aðgerðardag. Þessi háþróaði valkostur er tiltækur án þess að þyngja venjulegu sýnina.",
    "guide.6.heading": "Berðu sömu daga saman tvisvar",
    "guide.6.body": "Á tölvu virkjarðu samanburðinn á sama stað. Hver lína inniheldur nákvæmlega sama fyrirspurnardag; fyrri dálkurinn notar fyrri aðgerðardaginn og sá seinni hinn. Í dag á móti morgundeginum er sjálfgefið, svo auðvelt er að sjá hvaða Pastafari-dagsetningar breytast.",
    ...
    "reverse.basic.calculation.pastafari": "Aðgerðardagurinn er einnig Pastafari-dagur / háður öðrum dagsetningum",
    ...
    "reverse.constraint.calculationVariable": "Breyta aðgerðardags",
