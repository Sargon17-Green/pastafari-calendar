...
export default Object.freeze({
  ...
  "messages": {
    ...
    "about.fallbackNotice": "İzah hələ seçilmiş dildə mövcud deyil, buna görə standart versiya göstərilir.",
    ...
    "search.intro": "Təqvim seçin, tarix daxil edin və “Tarixi göstər” düyməsini seçin. Cari Pastafari günü standart olaraq əvvəlcədən doldurulur.",
    ...
    "settings.intro": "Əməl günü hesablamanın başlanğıc nöqtəsidir. Standart olaraq sayt aktiv müşahidəçi yeri üçün müəyyən edilmiş cari Pastafari günündən istifadə edir.",
    ...
    "guide.1.body": "Keçid açılan kimi sayt aktiv müşahidəçi yeri üçün cari Pastafari gününü müəyyən edir və həmin günü ehtiva edən kotleti göstərir. Gün sərhədi ASTRONOMICAL-DAY.md sənədində təsvir olunan, yerdən asılı Veneranın aşağı meridian keçididir; mülki gecəyarısı deyil. Qeydiyyat və giriş yoxdur, heç bir tarix hesablama serverinə göndərilmir.",
    ...
    "guide.4.body": "“Əvvəlki kotlet” və “Növbəti kotlet” qonşu kotletlərə keçir. Digər gün kartları düymə deyil, çünki onları klikləmək heç bir əməliyyat aparmır. “Bu günə qayıt” həm axtarışı, həm də əməl gününü cari Pastafari gününə qaytarır.",
    "guide.5.heading": "Əməl gününü dəyişin",
    "guide.5.body": "Axtarışın altındakı “Hesablama və müqayisə seçimləri” bölməsini açın. Orada təqvim seçib başqa əməl günü daxil edə bilərsiniz. Sonrakı axtarışlar cari Pastafari gününə qaytarana qədər həmin əməl günündən istifadə edir. Bu irəli səviyyəli parametr adi görünüşü yükləmədən əlçatan qalır.",
