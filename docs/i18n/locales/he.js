...
export default Object.freeze({
  ...
  messages: Object.freeze({
    ...
    "calendarHelp.hebrew": "מספור החודשים: ניסן הוא 1 ותשרי הוא 7; בשנה מעוברת אדר א' הוא 12 ואדר ב' הוא 13.",
    ...
    "calendarHelp.hindu": "הזינו שנה, חודש ויום לפי המניין ההינדואי העתיק. בלוח הירחי אפשר לסמן חודש מעובר.",
    "calendarHelp.japanese": "שנה 1 מתחילה ביום שבו החלה התקופה; תאריך שקדם לתחילתה או עבר את סופה לא יתקבל.",
    "calendarHelp.bahai": "בחרו חודש 1–19 או איאם־הא. שנת השוויון של טהראן נתמכת בטווח המקובל 1844–3000 בלוח הגריגוריאני.",
