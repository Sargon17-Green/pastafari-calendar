...
raise 'not a specification-derived canonical fixture' unless fixture['fixtureType'] == 'specification-derived-canonical'
...
if failures.empty?
  ...
  puts "canonical vectors: #{count}/#{count} passed"
else
