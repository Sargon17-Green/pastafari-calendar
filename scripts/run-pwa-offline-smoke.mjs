...
async function offlineReverseSmoke(page) {
  const result = await page.evaluate(async () => {
    ...
    const ids = await import("./i18n/calendar-identifiers.js?v=9-canonical-names");
...
try {
  ...
  assert.equal((await assertRuntimePresence(page, "./i18n/locales/fr.js?v=19-about-i18n", false)).present, false);
  ...
  const cachedHebrew = await assertRuntimePresence(page, "./i18n/locales/he.js?v=19-about-i18n", true);
  ...
  assert.equal((await assertRuntimePresence(page, "./i18n/locales/de.js?v=19-about-i18n", false)).present, false);
  ...
  await assertRuntimePresence(page, "./i18n/locales/he.js?v=19-about-i18n", true);
  ...
  const legacyMigration = await page.evaluate(async ({ runtimeCache }) => {
    const registration = await navigator.serviceWorker.ready;
    const localeUrl = new URL("./i18n/locales/fr.js?v=19-about-i18n", registration.scope).href;
  ...
  await assertRuntimePresence(page, "./i18n/locales/he.js?v=19-about-i18n", true);
  await assertRuntimePresence(page, "./i18n/locales/fr.js?v=19-about-i18n", true);
